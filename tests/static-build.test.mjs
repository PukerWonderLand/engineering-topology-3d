...
test("English and Chinese READMEs preserve the same information structure", async () => {
  ...
  for (const token of ["v0.2", "t113-arm-xvc", "nvme-bitmap", "SceneDefinition", "pnpm install --frozen-lockfile", "pnpm validate:scenes", "pnpm test", "CODE_PROVEN", "RTL_PROVEN", "RUNTIME_OBSERVED", "INFERRED"])
